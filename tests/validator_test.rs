use just_mcp_lib::validator::{validate_arguments, validate_with_help, get_signature_help, format_signature_help};
use just_mcp_lib::{Recipe, Parameter};
...
fn test_validate_complex_parameter_combinations() {
    let params = vec![
        Parameter { name: "required1".to_string(), default_value: None },
        Parameter { name: "optional1".to_string(), default_value: Some("default1".to_string()) },
        Parameter { name: "required2".to_string(), default_value: None },
        Parameter { name: "optional2".to_string(), default_value: Some("default2".to_string()) },
    ];
    let recipe = create_test_recipe("complex", params, Some("Complex recipe with mixed parameters"));
    ...
    let result = validate_arguments(&recipe, &["req1".to_string(), "opt1".to_string(), "req2".to_string()]);
...
fn test_validate_recipe_with_no_documentation() {
    let params = vec![
        Parameter { name: "param".to_string(), default_value: None },
    ];
...
fn test_validate_recipe_with_all_optional_parameters() {
    let params = vec![
        Parameter { name: "opt1".to_string(), default_value: Some("val1".to_string()) },
        Parameter { name: "opt2".to_string(), default_value: Some("val2".to_string()) },
        Parameter { name: "opt3".to_string(), default_value: Some("".to_string()) }, // Empty default
    ];
    ...
    let result = validate_arguments(&recipe, &["custom1".to_string(), "custom2".to_string(), "custom3".to_string()]);
    assert!(result.is_valid);
    
    // Invalid: too many arguments
    let result = validate_arguments(&recipe, &["1".to_string(), "2".to_string(), "3".to_string(), "4".to_string()]);
    assert!(!result.is_valid);
}
...
fn test_validate_recipe_with_all_required_parameters() {
    let params = vec![
        Parameter { name: "req1".to_string(), default_value: None },
        Parameter { name: "req2".to_string(), default_value: None },
        Parameter { name: "req3".to_string(), default_value: None },
    ];
    ...
    let result = validate_arguments(&recipe, &["arg1".to_string(), "arg2".to_string(), "arg3".to_string()]);
    assert!(result.is_valid);
}
...
fn test_signature_help_formatting_edge_cases() {
    ...
    let params = vec![
        Parameter { name: "param1".to_string(), default_value: None },
        Parameter { name: "param2".to_string(), default_value: None },
    ];
...
fn test_validate_with_help_comprehensive() {
    let params = vec![
        Parameter { name: "env".to_string(), default_value: None },
        Parameter { name: "region".to_string(), default_value: Some("us-east-1".to_string()) },
        Parameter { name: "dry_run".to_string(), default_value: Some("false".to_string()) },
    ];
    let recipe = create_test_recipe("deploy", params, Some("Deploy application to specified environment"));
...
fn test_parameter_with_empty_default_value() {
    let params = vec![
        Parameter { name: "message".to_string(), default_value: Some("".to_string()) },
    ];
...
fn test_validation_error_specificity() {
    let params = vec![
        Parameter { name: "first".to_string(), default_value: None },
        Parameter { name: "second".to_string(), default_value: None },
        Parameter { name: "third".to_string(), default_value: Some("default".to_string()) },
    ];
...
fn test_parameter_info_accuracy() {
    let params = vec![
        Parameter { name: "required_param".to_string(), default_value: None },
        Parameter { name: "optional_param".to_string(), default_value: Some("default_value".to_string()) },
    ];
    let recipe = create_test_recipe("test_recipe", params, Some("Test recipe for parameter info"));
    ...
    assert_eq!(optional_param.default_value, Some("default_value".to_string()));
